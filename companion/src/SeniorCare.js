...
const SeniorCare = ({ role, handleLogout }) => {
  ...
  const fetchAllData = async () => {
    try {
      const res = await fetch("https://backend-production-4629.up.railway.app/php/appointments.php", {
        method: "GET",
        credentials: "include",
      });
      ...
      const slotRes = await fetch("https://backend-production-4629.up.railway.app/php/get_service_slots.php", {
        credentials: "include",
      });
