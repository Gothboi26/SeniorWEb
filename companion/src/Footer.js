      ...
      <footer className="gov-footer">
        <div className="footer-container">
          ...
          <div>
            <h4>Contact</h4>
            <ul>
              <li>Gen. T. De Leon Road, Valenzuela City</li>
              <li>gentdeleonbarangay@gmail.com</li>
        ...
        <div className="bottom-footer">
          ...
          <p>© 2025 Barangay General Tiburcio De Leon. All rights reserved.</p>
        </div>
      </footer>
...
// Here are your ORIGINAL full modal contents you provided:
