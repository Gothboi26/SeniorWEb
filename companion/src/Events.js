...
const Events = () => {
  ...
  useEffect(() => {
    ...
    const url = `https://companionbackend-production.up.railway.app/get_events.php?date=${
  ...
  const saveEvent = () => {
    ...
    fetch("https://companionbackend-production.up.railway.app/add_events.php", {
      method: "POST",
      headers: {
  ...
  const deleteEvent = (id) => {
    if (window.confirm("Are you sure you want to delete this event?")) {
      setLoading(true);
      fetch(`https://companionbackend-production.up.railway.app/get_events.php?id=${id}`, {
        method: "POST",
      })
        .then((response) => response.json())
        .then((data) => {
