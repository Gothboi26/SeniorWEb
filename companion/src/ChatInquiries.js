...
const ChatInquiries = () => {
  ...
  const saveMessageToDatabase = (sender, receiver, content) => {
    fetch("https://backend-production-4629.up.railway.app/php/save_message.php", {
      method: "POST",
  ...
  const handleSelectUser = async (user) => {
    ...
    try {
      const res = await fetch(`https://backend-production-4629.up.railway.app/php/get_messages.php?sender=admin&receiver=${user.username}`);
