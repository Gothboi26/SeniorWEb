...
const SeniorList = () => {
  ...
  useEffect(() => {
    const fetchPatients = async () => {
      try {
        const response = await fetch("https://companionbackend-production.up.railway.app/get_users.php");
  ...
  const handleUpdateSenior = async () => {
    ...
    try {
      const response = await fetch("https://companionbackend-production.up.railway.app/update_user.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(payload)
      });
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch("https://companionbackend-production.up.railway.app/delete_user.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
