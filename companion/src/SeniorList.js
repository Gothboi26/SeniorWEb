...
const SeniorList = () => {
  ...
  const handleAddSenior = async () => {
    ...
    try {
      const res = await fetch("https://backend-production-4629.up.railway.app/php/register.php", {
        method: "POST",
  ...
  const handleUpdateSenior = async () => {
    ...
    try {
      const res = await fetch("https://backend-production-4629.up.railway.app/php/update_user.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch("https://backend-production-4629.up.railway.app/php/delete_user.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  useEffect(() => {
    const fetchPatients = async () => {
      try {
        const res = await fetch("https://backend-production-4629.up.railway.app/php/get_users.php");
