...
const Overview = () => {
  ...
  const fetchAppointmentsData = useCallback(() => {
    fetch("companionbackend-production.up.railway.app/appointments.php", {
...
const fetchAgeDistribution = useCallback(() => {
  fetch("companionbackend-production.up.railway.app/get_users.php")
    .then((response) => response.json())
    .then((data) => {
...
const getChartData = () => ({
  ...
  const handleDelete = (appointmentId) => {
    ...
    fetch(`companionbackend-production.up.railway.app/appointments.php?id=${appointmentId}`, {
      method: "DELETE",
    })
      .then((response) => response.json())
      .then(() => {
